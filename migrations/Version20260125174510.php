 ...
 */
final class Version20260125174510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD avatar_key VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD avatar_url TEXT DEFAULT NULL');
